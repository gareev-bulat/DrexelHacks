        ...
        <div className="absolute inset-0 h-full w-full bg-gradient-to-r from-green-400 to-blue-500">
          <div className="flex h-full items-center justify-center p-12">
            <div className="max-w-lg text-white">
              <h2 className="text-3xl font-bold mb-4">Make smarter investment decisions with AI</h2>
              <p className="text-lg">
                StockSense analyzes thousands of news sources in real-time to help you optimize your portfolio and stay
